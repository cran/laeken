...
\pkg{simPopulation} \citep{kraft10}. The data set \code{eusilc} is used in the 
...
calibration variables needs to be supplied via the argument \code{aux}. In 
